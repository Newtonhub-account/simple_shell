...
/* for reading and writing in the buffers */
...
/**
 *struct passinfo - contains pseudo to pass into a function.
 *@arg: a string generated from getline arguements.
 *@argv: an array of strings formulated from arg.
 *@path: a string path for the cdm
 ...
 *@environ: custom modified copy of environ from LL envss
